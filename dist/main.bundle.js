...
module.exports = "<!--MAIN APP PAGE WHERE ALL COMPONENTS ARE RENDERED-->\r\n<h1>\r\n  {{title}}\r\n</h1>\r\n<router-outlet></router-outlet>"
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_7__posts_service__["a" /* PostsService */], __WEBPACK_IMPORTED_MODULE_8__user_service__["a" /* UserService */]],
...
/***/ "../../../../../src/app/signup/password-validator.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__password_validator__ = __webpack_require__("../../../../../src/app/signup/password-validator.ts");
...
var SignupComponent = (function () {
    function SignupComponent(fb, userService) {
        ...
        this.signup_form = fb.group({
            name: ['Cole Wuilleumier', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].pattern("^[ A-Za-z ]+"), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].minLength(3), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].maxLength(30)])],
            email: ['crwuilleumier@gmail.com', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].pattern("^[A-Za-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[A-Za-z0-9]([A-Za-z0-9-]*[a-z0-9])?(\.[A-Za-z0-9]([A-Za-z0-9-]*[A-Za-z0-9])?)*$")])],
            password: ['password', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].pattern('(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}'), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].minLength(6)])],
            confirmPassword: ['password', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required]
        }, {
            validator: __WEBPACK_IMPORTED_MODULE_2__password_validator__["a" /* PasswordValidation */].MatchPassword // your validation method
        });
    }
    SignupComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.signup_form.valid) {
            this.user = new __WEBPACK_IMPORTED_MODULE_3__classes_user__["a" /* User */](null, this.signup_form.controls['name'].value, this.signup_form.controls['email'].value, this.signup_form.controls['password'].value);
            this.userService.create(this.user)
                ...
                _this.message = "An error has occured. Try refreshing page.";
            });
        }
        else {
...
SignupComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormBuilder */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormBuilder */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__user_service__["a" /* UserService */]) === "function" && _b || Object])
], SignupComponent);
...
var UserService = (function () {
    ...
    UserService.prototype.create = function (user) {
        return this.http.post('/api/addUser', user, this.jwt()).map(function (response) { return response.json(); });
    };
    ...
    UserService.prototype.jwt = function () {
        ...
        if (currentUser && currentUser.token) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ 'x-access-token': currentUser.token });
